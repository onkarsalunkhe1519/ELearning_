<%@ Page Title="Certificates" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminCertificate.aspx.cs" Inherits="ELearning_Team3.AdminCertificate" %>
...
<asp:GridView ID="GridViewCertificates" runat="server" AutoGenerateColumns="False" CssClass="grid-view" OnRowCommand="GridViewCertificates_RowCommand">
    <Columns>
        ...
        <asp:BoundField DataField="UserEmail" HeaderText="Certificate ID" />
